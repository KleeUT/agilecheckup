    ...
    advice: [
      {
        scores: [1, 2, 3],
        priority: 1,
        text: "There is no way to be truly agile if you are not able to iterate and change quickly. Anything you can do to decrease the time it takes to deliver to production will increase your agility. Allowing you to respond to change rather than following a plan.",
      },
      {
        scores: [4],
        priority: 20,
        text: "Looks like you're doing great. If anything deploying to production a little more often could make you even better.",
      },
      {
        scores: [5],
        priority: 99,
    ...
    advice: [
      {
        scores: [1, 2, 3],
        priority: 3,
        text: "Collaboration is a key factor in ensuring that a team is functional. Without good lines of communication a team will ship the wrong thing or spend time reworking as stake holders clarify requirements after the work is complete.",
      },
    ],
    options: [
      {
    ...
    advice: [
      {
        scores: [1, 2, 3],
        priority: 4,
        text: "At the heart of truly agile teams is self organization. The team should own the process and feel empowered to adjust those processes as they see fit",
      },
    ],
    options: [
      {
      ...
      {
        score: 2,
        text: "Rarely if ever. The processes are set out by management",
      },
      {
        score: 1,
        text: "We don't have retrospectives",
      },
    ],
  });
    ...
    advice: [
      {
        scores: [1, 2, 3],
        priority: 5,
        text: "Seems like it's time to get some production monitoring in place. If you can't see what your users are doing, where they're having problems and what features they're using how can you be confident that you are truly delivering value to your customers?",
      },
    ],
    options: [
      {
        score: 5,
        text: "Very confident, we know about problem before our users do.",
      },
      {
        score: 4,
        text: "Pretty good",
      ...
      {
        score: 3,
        text: "Somewhat, we have some logs they can usually help us solve issues.",
      },
      {
        score: 2,
    ...
    advice: [
      {
        scores: [1, 2, 3],
        priority: 4,
        text: "It would be a good idea to better communicate your product vision to the team. Getting the whole team on the same page about product vision means that everyone is empowered to make decisions that move the product forwards",
      },
    ],
    options: [
      {
